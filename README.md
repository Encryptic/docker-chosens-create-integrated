# Docker image for [Chosen's Create: Integrated](https://www.curseforge.com/minecraft/modpacks/chosens-create-integrated) from ChosenArchitect.
<!-- toc -->
...
* MOTD "Chosen's Create: Integrated Server Powered by Docker"
